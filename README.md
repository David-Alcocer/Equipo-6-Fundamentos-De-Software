...
| <img src="Imagenes/Rodrigo.JPG" width="120" alt="Rodrigo" style="border-radius: 10px;"> | Rodrigo Israel Salazar Pérez: En el proyecto asumo la responsabilidad de redacción y chequeo de los mock up para que pueda cumplir con su cometido , al igual que me involucro en la corrección de erroes en el proyecto.
